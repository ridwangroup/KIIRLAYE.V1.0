...
public class Main {
    ...
    public static void main(String[] args) throws NamingException {
       ...
       // ag3.setMatricule("RIDWAN-IPM-1945199");
        ...
        ag4.setEmail("aicha-ba@gmail.com");
        ag4.setTelephone("785055747");
